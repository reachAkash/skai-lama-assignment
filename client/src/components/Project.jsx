...
export const Project = ({ item }) => {
  ...
  return (
    <div
      ...
      className="w-1/5 flex items-center justify-start border-2 pl-2 pr-6 py-3 gap-4 border-gray-200 rounded-xl cursor-pointer group hover:bg-gray-50 transition-all duration-500 ease-in-out"
    >
